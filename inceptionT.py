...
# NOTE: inception input size is 299x299 not 224
data_transforms = {
        ...
        for stage in ['train', 'val']:
            ...
            for inputs, labels in dataloaders[stage]:
                ...
                with torch.set_grad_enabled(stage == 'train'):
                    ...
                    if stage == 'train':
                        # inception forward pass returns two outputs on training
...
if __name__ == '__main__':
    ...
    # final layers, inception v3 has an auxilary output layer as well
    model_conv.AuxLogits.fc = nn.Linear(768, 2)
    ...
    if FREEZE:
        params = list(model_conv.AuxLogits.fc.parameters()) + list(model_conv.fc.parameters())
    ...
    # save the model
    torch.save(model_conv,'models/inception3TELex.pt')